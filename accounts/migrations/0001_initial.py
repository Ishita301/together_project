    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('couple_since', models.DateField(blank=True, null=True)),
                ('anniversary', models.DateField(blank=True, null=True)),
                ('next_meeting', models.DateField(blank=True, null=True)),
                ('current_mood', models.CharField(blank=True, default='happy', max_length=50)),
                ('mood_message', models.CharField(blank=True, max_length=200)),
